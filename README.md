...
## Analysis Report: Top 10 Products by Sales and Profit

### Objective

Identify the top 10 products by sales and profit to assess their impact on revenue and profitability.

### Insights

#### Sales Performance

![Top 10 Products by Sales](top_10_products_by_sales.png | width=50%)

1. **High Revenue:** Top 10 products drive significant sales.
2. **Sales Concentration:** A few products dominate sales; consider diversifying.
3. **Sales vs. Profit:** High sales don’t always mean high profit.

#### Profit Performance

![Top 10 Products by Profit](top_10_products_by_profit.png | width=50%)

1. **Profit Variation:** High profit does not always match high sales.
2. **Growth Opportunities:** Focus on marketing profitable, low-sales products.
3. **Investment Focus:** Invest in products with both high sales and high profit.

### Graph Resizing

- **Width:** 50% of original
- **Height:** 50% of original

Adjust in your plotting code using:
